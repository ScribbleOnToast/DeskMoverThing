...
namespace App1
{
    public static class LinakUuids
    {
        ...
        {
            public static readonly byte[] MoveUp = [0x47, 0x00]; // Command to Move Up
            public static readonly byte[] TheFuck = [0xfe, 0x00]; //No idea what this is, but the bluetooth capture has it.
        }
    }
}
